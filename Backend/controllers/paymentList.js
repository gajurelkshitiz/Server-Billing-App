...
const createCustomerPayment = async (req, res) => {
    const {customerID, customerName, companyID, totalDueLeft, amountPaid, paymentMode, remarks} = req.body;
    if (!customerID || !customerName || !companyID || !totalDueLeft || !amountPaid || !paymentMode || !remarks){
