...
const ComputerizedPurchaseEntrySchema = new mongoose.Schema(
  {
    supplierID: {
      type: String,
...
module.exports =
  mongoose.models.ComputerizedPurchaseEntry ||
  mongoose.model("ComputerizedPurchaseEntry", ComputerizedPurchaseEntrySchema);
