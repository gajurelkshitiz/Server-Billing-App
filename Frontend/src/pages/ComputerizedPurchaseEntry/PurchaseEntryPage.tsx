...
const columns = [
  ...
  { key: "invoiceNo", label: "Invoice Number", sortable: true },
  { key: "date", label: "Date of Invoice", sortable: true },
...
interface PurchaseEntryPageProps {
  ...
  loading: boolean;
  handleAdd: () => void;
  handleEdit: (salesEntry: PurchaseEntry) => void;
  ...
  currentFilters?: any;
  onPreview?: (salesEntryId: string) => void;
}
  ...
  return (
    <>
      ...
      <DataTable
        ...
        currentPage={page}
        pageSize={limit}
        // Add custom row actions for print functionality
        rowActions={(row) => (
          <>
            {/* <Button 
              size="sm" 
