...
import { Supplier } from "@/pages/Supplier/types";
...
const PurchaseEntryFormModal: React.FC<PurchaseEntryFormModalProps> = ({
  isModalOpen,
  setIsModalOpen,
  formData,
  handleInputChange,
  ...
  }, [formData.supplierID, sameAsSupplier, suppliers]);
              ...
              <div className="flex items-center justify-between w-full mb-2">
                ...
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) => {
                      setSameAsSupplier(e.target.checked);
                    }}
                  />
