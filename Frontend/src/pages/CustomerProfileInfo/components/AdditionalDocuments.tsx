...
const AdditionalDocuments: React.FC<AdditionalDocumentsProps> = ({ customerId }) => {
  ...
  const [customerAttachments, setCustomerAttachments] = useState<CustomerAttachment[]>([]);
        ...
        <div className="p-6 border-b border-border">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold">Customer Attachments</h2>
          ...
          {customerAttachments.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-muted-foreground/70 mt-1">
                Customer documents will appear here when uploaded
              </p>
            </div>
          )}
        </div>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            BackDated cheques, bank guarantees, and customer attachments
          </p>
        </div>
